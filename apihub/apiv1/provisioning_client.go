...
func defaultProvisioningRESTCallOptions() *ProvisioningCallOptions {
...
// internalProvisioningClient is an interface that defines the methods available from API hub API.
...
// ProvisioningClient is a client for interacting with API hub API.
...
func (c *ProvisioningClient) CreateApiHubInstance(ctx context.Context, req *apihubpb.CreateApiHubInstanceRequest, opts ...gax.CallOption) (*CreateApiHubInstanceOperation, error) {
	return c.internalClient.CreateApiHubInstance(ctx, req, opts...)
}

// CreateApiHubInstanceOperation returns a new CreateApiHubInstanceOperation from a given name.
...
// LookupApiHubInstance looks up an Api Hub instance in a given GCP project. There will always be
// only one Api Hub instance for a GCP project across all locations.
func (c *ProvisioningClient) LookupApiHubInstance(ctx context.Context, req *apihubpb.LookupApiHubInstanceRequest, opts ...gax.CallOption) (*apihubpb.LookupApiHubInstanceResponse, error) {
	return c.internalClient.LookupApiHubInstance(ctx, req, opts...)
}
...
// Methods, except Close, may be called concurrently. However, fields must not be modified concurrently with method calls.
type provisioningRESTClient struct {
...
func NewProvisioningRESTClient(ctx context.Context, opts ...option.ClientOption) (*ProvisioningClient, error) {
	clientOpts := append(defaultProvisioningRESTClientOptions(), opts...)
	...
	callOpts := defaultProvisioningRESTCallOptions()
	c := &provisioningRESTClient{
		endpoint:    endpoint,
	...
	if gax.IsFeatureEnabled("METRICS") {
		...
		callOpts.CreateApiHubInstance = append(callOpts.CreateApiHubInstance, gax.WithClientMetrics(metrics))
		callOpts.DeleteApiHubInstance = append(callOpts.DeleteApiHubInstance, gax.WithClientMetrics(metrics))
		callOpts.GetApiHubInstance = append(callOpts.GetApiHubInstance, gax.WithClientMetrics(metrics))
		callOpts.LookupApiHubInstance = append(callOpts.LookupApiHubInstance, gax.WithClientMetrics(metrics))
	...
	return &ProvisioningClient{internalClient: c, CallOptions: callOpts}, nil
}

func defaultProvisioningRESTClientOptions() []option.ClientOption {
...
// Close closes the connection to the API service. **Always** call Close() when
// the client is no longer required.
func (c *provisioningRESTClient) Close() error {
...
func (c *provisioningRESTClient) Connection() *grpc.ClientConn {
	return nil
}

// CreateApiHubInstance provisions instance resources for the API Hub.
func (c *provisioningRESTClient) CreateApiHubInstance(ctx context.Context, req *apihubpb.CreateApiHubInstanceRequest, opts ...gax.CallOption) (*CreateApiHubInstanceOperation, error) {
	m := protojson.MarshalOptions{AllowPartial: true, UseEnumNumbers: true}
	body := req.GetApiHubInstance()
	...
	baseUrl.Path += fmt.Sprintf("/v1/%v/apiHubInstances", req.GetParent())

	params := url.Values{}
	params.Add("$alt", "json;enum-encoding=int")
	if req.GetApiHubInstanceId() != "" {
		params.Add("apiHubInstanceId", fmt.Sprintf("%v", req.GetApiHubInstanceId()))
	}
...
// GetApiHubInstance gets details of a single API Hub instance.
func (c *provisioningRESTClient) GetApiHubInstance(ctx context.Context, req *apihubpb.GetApiHubInstanceRequest, opts ...gax.CallOption) (*apihubpb.ApiHubInstance, error) {
	baseUrl, err := url.Parse(c.endpoint)
	if err != nil {
		return nil, err
	}
	...
	opts = append((*c.CallOptions).GetApiHubInstance[0:len((*c.CallOptions).GetApiHubInstance):len((*c.CallOptions).GetApiHubInstance)], opts...)
	unm := protojson.UnmarshalOptions{AllowPartial: true, DiscardUnknown: true}
	resp := &apihubpb.ApiHubInstance{}
	e := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
		if settings.Path != "" {
			baseUrl.Path = settings.Path
		}
...
// LookupApiHubInstance looks up an Api Hub instance in a given GCP project. There will always be
// only one Api Hub instance for a GCP project across all locations.
func (c *provisioningRESTClient) LookupApiHubInstance(ctx context.Context, req *apihubpb.LookupApiHubInstanceRequest, opts ...gax.CallOption) (*apihubpb.LookupApiHubInstanceResponse, error) {
	baseUrl, err := url.Parse(c.endpoint)
	if err != nil {
		return nil, err
	}
	baseUrl.Path += fmt.Sprintf("/v1/%v/apiHubInstances:lookup", req.GetParent())
	...
	opts = append((*c.CallOptions).LookupApiHubInstance[0:len((*c.CallOptions).LookupApiHubInstance):len((*c.CallOptions).LookupApiHubInstance)], opts...)
	unm := protojson.UnmarshalOptions{AllowPartial: true, DiscardUnknown: true}
	resp := &apihubpb.LookupApiHubInstanceResponse{}
	e := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
		if settings.Path != "" {
			baseUrl.Path = settings.Path
		}
...
// GetLocation gets information about a location.
func (c *provisioningRESTClient) GetLocation(ctx context.Context, req *locationpb.GetLocationRequest, opts ...gax.CallOption) (*locationpb.Location, error) {
	baseUrl, err := url.Parse(c.endpoint)
	if err != nil {
		return nil, err
	}
...
// ListLocations lists information about the supported locations for this service.
func (c *provisioningRESTClient) ListLocations(ctx context.Context, req *locationpb.ListLocationsRequest, opts ...gax.CallOption) *LocationIterator {
	it := &LocationIterator{}
...
// CancelOperation is a utility method from google.longrunning.Operations.
func (c *provisioningRESTClient) CancelOperation(ctx context.Context, req *longrunningpb.CancelOperationRequest, opts ...gax.CallOption) error {
	m := protojson.MarshalOptions{AllowPartial: true, UseEnumNumbers: true}
...
// DeleteOperation is a utility method from google.longrunning.Operations.
func (c *provisioningRESTClient) DeleteOperation(ctx context.Context, req *longrunningpb.DeleteOperationRequest, opts ...gax.CallOption) error {
	baseUrl, err := url.Parse(c.endpoint)
	if err != nil {
		return err
	}
...
// GetOperation is a utility method from google.longrunning.Operations.
func (c *provisioningRESTClient) GetOperation(ctx context.Context, req *longrunningpb.GetOperationRequest, opts ...gax.CallOption) (*longrunningpb.Operation, error) {
	baseUrl, err := url.Parse(c.endpoint)
	if err != nil {
		return nil, err
	}
...
// ListOperations is a utility method from google.longrunning.Operations.
func (c *provisioningRESTClient) ListOperations(ctx context.Context, req *longrunningpb.ListOperationsRequest, opts ...gax.CallOption) *OperationIterator {
