...
type internalTermsOfServiceClient interface {
	...
	AcceptTermsOfService(context.Context, *accountspb.AcceptTermsOfServiceRequest, ...gax.CallOption) (*accountspb.AcceptTermsOfServiceResponse, error)
}
...
func (c *termsOfServiceGRPCClient) GetTermsOfService(ctx context.Context, req *accountspb.GetTermsOfServiceRequest, opts ...gax.CallOption) (*accountspb.TermsOfService, error) {
	...
	if gax.IsFeatureEnabled("METRICS") || gax.IsFeatureEnabled("TRACING") || gax.IsFeatureEnabled("LOGGING") {
		ctx = callctx.WithTelemetryContext(ctx, "rpc_method", "google.shopping.merchant.accounts.v1.TermsOfServiceService/GetTermsOfService")
	}
...
func (c *termsOfServiceGRPCClient) RetrieveLatestTermsOfService(ctx context.Context, req *accountspb.RetrieveLatestTermsOfServiceRequest, opts ...gax.CallOption) (*accountspb.TermsOfService, error) {
	...
	if gax.IsFeatureEnabled("METRICS") || gax.IsFeatureEnabled("TRACING") || gax.IsFeatureEnabled("LOGGING") {
		ctx = callctx.WithTelemetryContext(ctx, "rpc_method", "google.shopping.merchant.accounts.v1.TermsOfServiceService/RetrieveLatestTermsOfService")
	}
...
func (c *termsOfServiceGRPCClient) AcceptTermsOfService(ctx context.Context, req *accountspb.AcceptTermsOfServiceRequest, opts ...gax.CallOption) (*accountspb.AcceptTermsOfServiceResponse, error) {
	hds := []string{"x-goog-request-params", fmt.Sprintf("%s=%v", "name", url.QueryEscape(req.GetName()))}
	...
	if gax.IsFeatureEnabled("METRICS") || gax.IsFeatureEnabled("TRACING") || gax.IsFeatureEnabled("LOGGING") {
		ctx = callctx.WithTelemetryContext(ctx, "rpc_method", "google.shopping.merchant.accounts.v1.TermsOfServiceService/AcceptTermsOfService")
	}
	...
	var resp *accountspb.AcceptTermsOfServiceResponse
	err := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
		var err error
		resp, err = executeRPC(ctx, c.termsOfServiceClient.AcceptTermsOfService, req, settings.GRPC, c.logger, "AcceptTermsOfService")
		return err
	}, opts...)
	if err != nil {
		return nil, err
...
func (c *termsOfServiceRESTClient) GetTermsOfService(ctx context.Context, req *accountspb.GetTermsOfServiceRequest, opts ...gax.CallOption) (*accountspb.TermsOfService, error) {
	...
	if gax.IsFeatureEnabled("METRICS") || gax.IsFeatureEnabled("TRACING") || gax.IsFeatureEnabled("LOGGING") {
		ctx = callctx.WithTelemetryContext(ctx, "rpc_method", "google.shopping.merchant.accounts.v1.TermsOfServiceService/GetTermsOfService")
		ctx = callctx.WithTelemetryContext(ctx, "url_template", "/accounts/v1/{name=termsOfService/*}")
	}
	opts = append((*c.CallOptions).GetTermsOfService[0:len((*c.CallOptions).GetTermsOfService):len((*c.CallOptions).GetTermsOfService)], opts...)
...
func (c *termsOfServiceRESTClient) RetrieveLatestTermsOfService(ctx context.Context, req *accountspb.RetrieveLatestTermsOfServiceRequest, opts ...gax.CallOption) (*accountspb.TermsOfService, error) {
	...
	baseUrl.Path += fmt.Sprintf("/accounts/v1/termsOfService:retrieveLatest")
	...
	if gax.IsFeatureEnabled("METRICS") || gax.IsFeatureEnabled("TRACING") || gax.IsFeatureEnabled("LOGGING") {
		ctx = callctx.WithTelemetryContext(ctx, "rpc_method", "google.shopping.merchant.accounts.v1.TermsOfServiceService/RetrieveLatestTermsOfService")
		ctx = callctx.WithTelemetryContext(ctx, "url_template", "/accounts/v1/termsOfService:retrieveLatest")
	}
	opts = append((*c.CallOptions).RetrieveLatestTermsOfService[0:len((*c.CallOptions).RetrieveLatestTermsOfService):len((*c.CallOptions).RetrieveLatestTermsOfService)], opts...)
	unm := protojson.UnmarshalOptions{AllowPartial: true, DiscardUnknown: true}
	resp := &accountspb.TermsOfService{}
...
// AcceptTermsOfService accepts a TermsOfService. Executing this method requires admin access.
func (c *termsOfServiceRESTClient) AcceptTermsOfService(ctx context.Context, req *accountspb.AcceptTermsOfServiceRequest, opts ...gax.CallOption) (*accountspb.AcceptTermsOfServiceResponse, error) {
	baseUrl, err := url.Parse(c.endpoint)
	if err != nil {
		return nil, err
	}
	baseUrl.Path += fmt.Sprintf("/accounts/v1/%v:accept", req.GetName())
	...
	if gax.IsFeatureEnabled("METRICS") || gax.IsFeatureEnabled("TRACING") || gax.IsFeatureEnabled("LOGGING") {
		ctx = callctx.WithTelemetryContext(ctx, "rpc_method", "google.shopping.merchant.accounts.v1.TermsOfServiceService/AcceptTermsOfService")
		ctx = callctx.WithTelemetryContext(ctx, "url_template", "/accounts/v1/{name=termsOfService/*}:accept")
	}
	opts = append((*c.CallOptions).AcceptTermsOfService[0:len((*c.CallOptions).AcceptTermsOfService):len((*c.CallOptions).AcceptTermsOfService)], opts...)
	unm := protojson.UnmarshalOptions{AllowPartial: true, DiscardUnknown: true}
	resp := &accountspb.AcceptTermsOfServiceResponse{}
	e := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
		if settings.Path != "" {
			baseUrl.Path = settings.Path
		}
		...
		buf, err := executeHTTPRequest(ctx, c.httpClient, httpReq, c.logger, nil, "AcceptTermsOfService")
		if err != nil {
			return err
		}
