...
type internalClient interface {
	...
	GetDataSource(context.Context, *datasourcespb.GetDataSourceRequest, ...gax.CallOption) (*datasourcespb.DataSource, error)
	ListDataSources(context.Context, *datasourcespb.ListDataSourcesRequest, ...gax.CallOption) *DataSourceIterator
	CreateDataSource(context.Context, *datasourcespb.CreateDataSourceRequest, ...gax.CallOption) (*datasourcespb.DataSource, error)
	UpdateDataSource(context.Context, *datasourcespb.UpdateDataSourceRequest, ...gax.CallOption) (*datasourcespb.DataSource, error)
	DeleteDataSource(context.Context, *datasourcespb.DeleteDataSourceRequest, ...gax.CallOption) error
	FetchDataSource(context.Context, *datasourcespb.FetchDataSourceRequest, ...gax.CallOption) error
}
...
func (c *Client) CreateDataSource(ctx context.Context, req *datasourcespb.CreateDataSourceRequest, opts ...gax.CallOption) (*datasourcespb.DataSource, error) {
	return c.internalClient.CreateDataSource(ctx, req, opts...)
}

// UpdateDataSource updates the existing data source configuration. The fields that are
...
func (c *Client) DeleteDataSource(ctx context.Context, req *datasourcespb.DeleteDataSourceRequest, opts ...gax.CallOption) error {
	return c.internalClient.DeleteDataSource(ctx, req, opts...)
}

// FetchDataSource performs the data fetch immediately (even outside fetch schedule) on a
...
func (c *Client) FetchDataSource(ctx context.Context, req *datasourcespb.FetchDataSourceRequest, opts ...gax.CallOption) error {
	return c.internalClient.FetchDataSource(ctx, req, opts...)
}
...
type gRPCClient struct {
	...
	// The gRPC API client.
	client datasourcespb.DataSourcesServiceClient
...
func (c *gRPCClient) GetDataSource(ctx context.Context, req *datasourcespb.GetDataSourceRequest, opts ...gax.CallOption) (*datasourcespb.DataSource, error) {
	...
	if gax.IsFeatureEnabled("METRICS") || gax.IsFeatureEnabled("TRACING") || gax.IsFeatureEnabled("LOGGING") {
		ctx = callctx.WithTelemetryContext(ctx, "rpc_method", "google.shopping.merchant.datasources.v1beta.DataSourcesService/GetDataSource")
	}
...
func (c *gRPCClient) ListDataSources(ctx context.Context, req *datasourcespb.ListDataSourcesRequest, opts ...gax.CallOption) *DataSourceIterator {
	...
	if gax.IsFeatureEnabled("METRICS") || gax.IsFeatureEnabled("TRACING") || gax.IsFeatureEnabled("LOGGING") {
		ctx = callctx.WithTelemetryContext(ctx, "rpc_method", "google.shopping.merchant.datasources.v1beta.DataSourcesService/ListDataSources")
	}
...
func (c *gRPCClient) CreateDataSource(ctx context.Context, req *datasourcespb.CreateDataSourceRequest, opts ...gax.CallOption) (*datasourcespb.DataSource, error) {
	hds := []string{"x-goog-request-params", fmt.Sprintf("%s=%v", "parent", url.QueryEscape(req.GetParent()))}
	...
	if gax.IsFeatureEnabled("METRICS") || gax.IsFeatureEnabled("TRACING") || gax.IsFeatureEnabled("LOGGING") {
		ctx = callctx.WithTelemetryContext(ctx, "rpc_method", "google.shopping.merchant.datasources.v1beta.DataSourcesService/CreateDataSource")
	}
...
func (c *gRPCClient) UpdateDataSource(ctx context.Context, req *datasourcespb.UpdateDataSourceRequest, opts ...gax.CallOption) (*datasourcespb.DataSource, error) {
	hds := []string{"x-goog-request-params", fmt.Sprintf("%s=%v", "data_source.name", url.QueryEscape(req.GetDataSource().GetName()))}

	hds = append(c.xGoogHeaders, hds...)
	ctx = gax.InsertMetadataIntoOutgoingContext(ctx, hds...)
	if gax.IsFeatureEnabled("METRICS") || gax.IsFeatureEnabled("TRACING") || gax.IsFeatureEnabled("LOGGING") {
		ctx = callctx.WithTelemetryContext(ctx, "rpc_method", "google.shopping.merchant.datasources.v1beta.DataSourcesService/UpdateDataSource")
	}
...
func (c *gRPCClient) DeleteDataSource(ctx context.Context, req *datasourcespb.DeleteDataSourceRequest, opts ...gax.CallOption) error {
	hds := []string{"x-goog-request-params", fmt.Sprintf("%s=%v", "name", url.QueryEscape(req.GetName()))}
	...
	if gax.IsFeatureEnabled("METRICS") || gax.IsFeatureEnabled("TRACING") || gax.IsFeatureEnabled("LOGGING") {
		ctx = callctx.WithTelemetryContext(ctx, "rpc_method", "google.shopping.merchant.datasources.v1beta.DataSourcesService/DeleteDataSource")
	}
...
func (c *gRPCClient) FetchDataSource(ctx context.Context, req *datasourcespb.FetchDataSourceRequest, opts ...gax.CallOption) error {
	hds := []string{"x-goog-request-params", fmt.Sprintf("%s=%v", "name", url.QueryEscape(req.GetName()))}
	...
	if gax.IsFeatureEnabled("METRICS") || gax.IsFeatureEnabled("TRACING") || gax.IsFeatureEnabled("LOGGING") {
		ctx = callctx.WithTelemetryContext(ctx, "rpc_method", "google.shopping.merchant.datasources.v1beta.DataSourcesService/FetchDataSource")
	}
...
// GetDataSource retrieves the data source configuration for the given account.
func (c *restClient) GetDataSource(ctx context.Context, req *datasourcespb.GetDataSourceRequest, opts ...gax.CallOption) (*datasourcespb.DataSource, error) {
	...
	if gax.IsFeatureEnabled("METRICS") || gax.IsFeatureEnabled("TRACING") || gax.IsFeatureEnabled("LOGGING") {
		ctx = callctx.WithTelemetryContext(ctx, "rpc_method", "google.shopping.merchant.datasources.v1beta.DataSourcesService/GetDataSource")
		ctx = callctx.WithTelemetryContext(ctx, "url_template", "/datasources/v1beta/{name=accounts/*/dataSources/*}")
	}
	opts = append((*c.CallOptions).GetDataSource[0:len((*c.CallOptions).GetDataSource):len((*c.CallOptions).GetDataSource)], opts...)
...
func (c *restClient) ListDataSources(ctx context.Context, req *datasourcespb.ListDataSourcesRequest, opts ...gax.CallOption) *DataSourceIterator {
	...
	it.InternalFetch = func(pageSize int, pageToken string) ([]*datasourcespb.DataSource, string, error) {
		...
		baseUrl.Path += fmt.Sprintf("/datasources/v1beta/%v/dataSources", req.GetParent())
...
// CreateDataSource creates the new data source configuration for the given account.
func (c *restClient) CreateDataSource(ctx context.Context, req *datasourcespb.CreateDataSourceRequest, opts ...gax.CallOption) (*datasourcespb.DataSource, error) {
	...
	if gax.IsFeatureEnabled("METRICS") || gax.IsFeatureEnabled("TRACING") || gax.IsFeatureEnabled("LOGGING") {
		ctx = callctx.WithTelemetryContext(ctx, "rpc_method", "google.shopping.merchant.datasources.v1beta.DataSourcesService/CreateDataSource")
		ctx = callctx.WithTelemetryContext(ctx, "url_template", "/datasources/v1beta/{parent=accounts/*}/dataSources")
	}
	opts = append((*c.CallOptions).CreateDataSource[0:len((*c.CallOptions).CreateDataSource):len((*c.CallOptions).CreateDataSource)], opts...)
	unm := protojson.UnmarshalOptions{AllowPartial: true, DiscardUnknown: true}
	resp := &datasourcespb.DataSource{}
...
// UpdateDataSource updates the existing data source configuration. The fields that are
// set in the update mask but not provided in the resource will be deleted.
func (c *restClient) UpdateDataSource(ctx context.Context, req *datasourcespb.UpdateDataSourceRequest, opts ...gax.CallOption) (*datasourcespb.DataSource, error) {
	m := protojson.MarshalOptions{AllowPartial: true, UseEnumNumbers: true}
	body := req.GetDataSource()
	jsonReq, err := m.Marshal(body)
	if err != nil {
	...
	baseUrl.Path += fmt.Sprintf("/datasources/v1beta/%v", req.GetDataSource().GetName())
	...
	if gax.IsFeatureEnabled("METRICS") || gax.IsFeatureEnabled("TRACING") || gax.IsFeatureEnabled("LOGGING") {
		ctx = callctx.WithTelemetryContext(ctx, "rpc_method", "google.shopping.merchant.datasources.v1beta.DataSourcesService/UpdateDataSource")
		ctx = callctx.WithTelemetryContext(ctx, "url_template", "/datasources/v1beta/{data_source.name=accounts/*/dataSources/*}")
	}
	opts = append((*c.CallOptions).UpdateDataSource[0:len((*c.CallOptions).UpdateDataSource):len((*c.CallOptions).UpdateDataSource)], opts...)
	unm := protojson.UnmarshalOptions{AllowPartial: true, DiscardUnknown: true}
	resp := &datasourcespb.DataSource{}
...
// DeleteDataSource deletes a data source from your Merchant Center account.
func (c *restClient) DeleteDataSource(ctx context.Context, req *datasourcespb.DeleteDataSourceRequest, opts ...gax.CallOption) error {
	baseUrl, err := url.Parse(c.endpoint)
	if err != nil {
		return err
	}
...
// update your product data instead.
// This method only works on data sources with a file input set.
func (c *restClient) FetchDataSource(ctx context.Context, req *datasourcespb.FetchDataSourceRequest, opts ...gax.CallOption) error {
	m := protojson.MarshalOptions{AllowPartial: true, UseEnumNumbers: true}
	...
	baseUrl.Path += fmt.Sprintf("/datasources/v1beta/%v:fetch", req.GetName())
	...
	if gax.IsFeatureEnabled("METRICS") || gax.IsFeatureEnabled("TRACING") || gax.IsFeatureEnabled("LOGGING") {
		ctx = callctx.WithTelemetryContext(ctx, "rpc_method", "google.shopping.merchant.datasources.v1beta.DataSourcesService/FetchDataSource")
		ctx = callctx.WithTelemetryContext(ctx, "url_template", "/datasources/v1beta/{name=accounts/*/dataSources/*}:fetch")
	}
	return gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
		if settings.Path != "" {
			baseUrl.Path = settings.Path
