...
func (c *encryptionSpecGRPCClient) InitializeEncryptionSpec(ctx context.Context, req *dialogflowpb.InitializeEncryptionSpecRequest, opts ...gax.CallOption) (*InitializeEncryptionSpecOperation, error) {
	...
	ctx = gax.InsertMetadataIntoOutgoingContext(ctx, hds...)
	if gax.IsFeatureEnabled("METRICS") || gax.IsFeatureEnabled("TRACING") || gax.IsFeatureEnabled("LOGGING") {
		ctx = callctx.WithTelemetryContext(ctx, "rpc_method", "google.cloud.dialogflow.v2beta1.EncryptionSpecService/InitializeEncryptionSpec")
	}
...
func (c *encryptionSpecRESTClient) InitializeEncryptionSpec(ctx context.Context, req *dialogflowpb.InitializeEncryptionSpecRequest, opts ...gax.CallOption) (*InitializeEncryptionSpecOperation, error) {
	...
	if gax.IsFeatureEnabled("METRICS") || gax.IsFeatureEnabled("TRACING") || gax.IsFeatureEnabled("LOGGING") {
		ctx = callctx.WithTelemetryContext(ctx, "rpc_method", "google.cloud.dialogflow.v2beta1.EncryptionSpecService/InitializeEncryptionSpec")
		ctx = callctx.WithTelemetryContext(ctx, "url_template", "/v2beta1/{encryption_spec.name=projects/*/locations/*/encryptionSpec}:initialize")
	}
	unm := protojson.UnmarshalOptions{AllowPartial: true, DiscardUnknown: true}
