...
func NewClient(ctx context.Context, opts ...option.ClientOption) (*Client, error) {
	...
	if gax.IsFeatureEnabled("TRACING") || gax.IsFeatureEnabled("LOGGING") {
		clientOpts = append(clientOpts, internaloption.WithTelemetryAttributes(map[string]string{
			...
			"gcp.client.artifact": "cloud.google.com/go/cloudtasks/apiv2beta2",
	...
	if gax.IsFeatureEnabled("METRICS") {
		...
		client.CallOptions.UploadQueueYaml = append(client.CallOptions.UploadQueueYaml, gax.WithClientMetrics(metrics))
		...
		client.CallOptions.LeaseTasks = append(client.CallOptions.LeaseTasks, gax.WithClientMetrics(metrics))
		client.CallOptions.AcknowledgeTask = append(client.CallOptions.AcknowledgeTask, gax.WithClientMetrics(metrics))
		client.CallOptions.RenewLease = append(client.CallOptions.RenewLease, gax.WithClientMetrics(metrics))
		client.CallOptions.CancelLease = append(client.CallOptions.CancelLease, gax.WithClientMetrics(metrics))
...
func NewRESTClient(ctx context.Context, opts ...option.ClientOption) (*Client, error) {
	...
	if gax.IsFeatureEnabled("METRICS") {
		...
		callOpts.UploadQueueYaml = append(callOpts.UploadQueueYaml, gax.WithClientMetrics(metrics))
		...
		callOpts.LeaseTasks = append(callOpts.LeaseTasks, gax.WithClientMetrics(metrics))
		callOpts.AcknowledgeTask = append(callOpts.AcknowledgeTask, gax.WithClientMetrics(metrics))
		callOpts.RenewLease = append(callOpts.RenewLease, gax.WithClientMetrics(metrics))
		callOpts.CancelLease = append(callOpts.CancelLease, gax.WithClientMetrics(metrics))
...
func (c *gRPCClient) UpdateQueue(ctx context.Context, req *cloudtaskspb.UpdateQueueRequest, opts ...gax.CallOption) (*cloudtaskspb.Queue, error) {
	...
	ctx = gax.InsertMetadataIntoOutgoingContext(ctx, hds...)
	if gax.IsFeatureEnabled("METRICS") || gax.IsFeatureEnabled("TRACING") || gax.IsFeatureEnabled("LOGGING") {
		ctx = callctx.WithTelemetryContext(ctx, "rpc_method", "google.cloud.tasks.v2beta2.CloudTasks/UpdateQueue")
	}
...
func (c *gRPCClient) UploadQueueYaml(ctx context.Context, req *cloudtaskspb.UploadQueueYamlRequest, opts ...gax.CallOption) error {
	...
	if gax.IsFeatureEnabled("METRICS") || gax.IsFeatureEnabled("TRACING") || gax.IsFeatureEnabled("LOGGING") {
		ctx = callctx.WithTelemetryContext(ctx, "rpc_method", "google.cloud.tasks.v2beta2.CloudTasks/UploadQueueYaml")
	}
	opts = append((*c.CallOptions).UploadQueueYaml[0:len((*c.CallOptions).UploadQueueYaml):len((*c.CallOptions).UploadQueueYaml)], opts...)
	err := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
		var err error
		_, err = executeRPC(ctx, c.client.UploadQueueYaml, req, settings.GRPC, c.logger, "UploadQueueYaml")
		return err
	}, opts...)
	return err
}
...
func (c *gRPCClient) LeaseTasks(ctx context.Context, req *cloudtaskspb.LeaseTasksRequest, opts ...gax.CallOption) (*cloudtaskspb.LeaseTasksResponse, error) {
	...
	err := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
		var err error
		resp, err = executeRPC(ctx, c.client.LeaseTasks, req, settings.GRPC, c.logger, "LeaseTasks")
		return err
	}, opts...)
	if err != nil {
		return nil, err
...
func (c *gRPCClient) AcknowledgeTask(ctx context.Context, req *cloudtaskspb.AcknowledgeTaskRequest, opts ...gax.CallOption) error {
	...
	err := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
		var err error
		_, err = executeRPC(ctx, c.client.AcknowledgeTask, req, settings.GRPC, c.logger, "AcknowledgeTask")
		return err
	}, opts...)
	return err
}
...
func (c *gRPCClient) RenewLease(ctx context.Context, req *cloudtaskspb.RenewLeaseRequest, opts ...gax.CallOption) (*cloudtaskspb.Task, error) {
	...
	err := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
		var err error
		resp, err = executeRPC(ctx, c.client.RenewLease, req, settings.GRPC, c.logger, "RenewLease")
		return err
	}, opts...)
	if err != nil {
		return nil, err
...
func (c *gRPCClient) CancelLease(ctx context.Context, req *cloudtaskspb.CancelLeaseRequest, opts ...gax.CallOption) (*cloudtaskspb.Task, error) {
	...
	err := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
		var err error
		resp, err = executeRPC(ctx, c.client.CancelLease, req, settings.GRPC, c.logger, "CancelLease")
		return err
	}, opts...)
	if err != nil {
		return nil, err
...
func (c *restClient) UpdateQueue(ctx context.Context, req *cloudtaskspb.UpdateQueueRequest, opts ...gax.CallOption) (*cloudtaskspb.Queue, error) {
	...
	if gax.IsFeatureEnabled("METRICS") || gax.IsFeatureEnabled("TRACING") || gax.IsFeatureEnabled("LOGGING") {
		ctx = callctx.WithTelemetryContext(ctx, "rpc_method", "google.cloud.tasks.v2beta2.CloudTasks/UpdateQueue")
		ctx = callctx.WithTelemetryContext(ctx, "url_template", "/v2beta2/{queue.name=projects/*/locations/*/queues/*}")
	}
	opts = append((*c.CallOptions).UpdateQueue[0:len((*c.CallOptions).UpdateQueue):len((*c.CallOptions).UpdateQueue)], opts...)
	unm := protojson.UnmarshalOptions{AllowPartial: true, DiscardUnknown: true}
	resp := &cloudtaskspb.Queue{}
...
func (c *restClient) UploadQueueYaml(ctx context.Context, req *cloudtaskspb.UploadQueueYamlRequest, opts ...gax.CallOption) error {
	...
	return gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
		...
		httpReq, err := http.NewRequestWithContext(ctx, "", baseUrl.String(), nil)
		if err != nil {
			return err
		}
		httpReq.Header = headers

		_, err = executeHTTPRequest(ctx, c.httpClient, httpReq, c.logger, nil, "UploadQueueYaml")
		return err
	}, opts...)
}
...
func (c *restClient) LeaseTasks(ctx context.Context, req *cloudtaskspb.LeaseTasksRequest, opts ...gax.CallOption) (*cloudtaskspb.LeaseTasksResponse, error) {
	...
	e := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
		...
		buf, err := executeHTTPRequest(ctx, c.httpClient, httpReq, c.logger, jsonReq, "LeaseTasks")
		if err != nil {
			return err
		}
...
func (c *restClient) AcknowledgeTask(ctx context.Context, req *cloudtaskspb.AcknowledgeTaskRequest, opts ...gax.CallOption) error {
	...
	return gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
		...
		_, err = executeHTTPRequest(ctx, c.httpClient, httpReq, c.logger, jsonReq, "AcknowledgeTask")
		return err
	}, opts...)
}
...
func (c *restClient) CancelLease(ctx context.Context, req *cloudtaskspb.CancelLeaseRequest, opts ...gax.CallOption) (*cloudtaskspb.Task, error) {
	...
	e := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
		...
		buf, err := executeHTTPRequest(ctx, c.httpClient, httpReq, c.logger, jsonReq, "CancelLease")
		if err != nil {
			return err
		}
...
func (c *restClient) GetLocation(ctx context.Context, req *locationpb.GetLocationRequest, opts ...gax.CallOption) (*locationpb.Location, error) {
	...
	if gax.IsFeatureEnabled("METRICS") || gax.IsFeatureEnabled("TRACING") || gax.IsFeatureEnabled("LOGGING") {
		ctx = callctx.WithTelemetryContext(ctx, "rpc_method", "google.cloud.location.Locations/GetLocation")
		ctx = callctx.WithTelemetryContext(ctx, "url_template", "/v2beta2/{name=projects/*/locations/*}")
	}
	opts = append((*c.CallOptions).GetLocation[0:len((*c.CallOptions).GetLocation):len((*c.CallOptions).GetLocation)], opts...)
	unm := protojson.UnmarshalOptions{AllowPartial: true, DiscardUnknown: true}
