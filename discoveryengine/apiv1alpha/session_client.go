...
type internalSessionClient interface {
	...
	ListFiles(context.Context, *discoveryenginepb.ListFilesRequest, ...gax.CallOption) *FileMetadataIterator
...
func (c *SessionClient) ListFiles(ctx context.Context, req *discoveryenginepb.ListFilesRequest, opts ...gax.CallOption) *FileMetadataIterator {
...
func (c *sessionGRPCClient) CreateSession(ctx context.Context, req *discoveryenginepb.CreateSessionRequest, opts ...gax.CallOption) (*discoveryenginepb.Session, error) {
	...
	if gax.IsFeatureEnabled("METRICS") || gax.IsFeatureEnabled("TRACING") || gax.IsFeatureEnabled("LOGGING") {
		ctx = callctx.WithTelemetryContext(ctx, "rpc_method", "google.cloud.discoveryengine.v1alpha.SessionService/CreateSession")
	}
...
func (c *sessionGRPCClient) DeleteSession(ctx context.Context, req *discoveryenginepb.DeleteSessionRequest, opts ...gax.CallOption) error {
	...
	if gax.IsFeatureEnabled("METRICS") || gax.IsFeatureEnabled("TRACING") || gax.IsFeatureEnabled("LOGGING") {
		ctx = callctx.WithTelemetryContext(ctx, "rpc_method", "google.cloud.discoveryengine.v1alpha.SessionService/DeleteSession")
	}
...
func (c *sessionGRPCClient) UpdateSession(ctx context.Context, req *discoveryenginepb.UpdateSessionRequest, opts ...gax.CallOption) (*discoveryenginepb.Session, error) {
	...
	ctx = gax.InsertMetadataIntoOutgoingContext(ctx, hds...)
	if gax.IsFeatureEnabled("METRICS") || gax.IsFeatureEnabled("TRACING") || gax.IsFeatureEnabled("LOGGING") {
		ctx = callctx.WithTelemetryContext(ctx, "rpc_method", "google.cloud.discoveryengine.v1alpha.SessionService/UpdateSession")
	}
...
func (c *sessionGRPCClient) GetSession(ctx context.Context, req *discoveryenginepb.GetSessionRequest, opts ...gax.CallOption) (*discoveryenginepb.Session, error) {
	...
	if gax.IsFeatureEnabled("METRICS") || gax.IsFeatureEnabled("TRACING") || gax.IsFeatureEnabled("LOGGING") {
		ctx = callctx.WithTelemetryContext(ctx, "rpc_method", "google.cloud.discoveryengine.v1alpha.SessionService/GetSession")
	}
...
func (c *sessionGRPCClient) ListSessions(ctx context.Context, req *discoveryenginepb.ListSessionsRequest, opts ...gax.CallOption) *SessionIterator {
	...
	if gax.IsFeatureEnabled("METRICS") || gax.IsFeatureEnabled("TRACING") || gax.IsFeatureEnabled("LOGGING") {
		ctx = callctx.WithTelemetryContext(ctx, "rpc_method", "google.cloud.discoveryengine.v1alpha.SessionService/ListSessions")
	}
...
func (c *sessionGRPCClient) ListFiles(ctx context.Context, req *discoveryenginepb.ListFilesRequest, opts ...gax.CallOption) *FileMetadataIterator {
	hds := []string{"x-goog-request-params", fmt.Sprintf("%s=%v", "parent", url.QueryEscape(req.GetParent()))}
	...
	if gax.IsFeatureEnabled("METRICS") || gax.IsFeatureEnabled("TRACING") || gax.IsFeatureEnabled("LOGGING") {
		ctx = callctx.WithTelemetryContext(ctx, "rpc_method", "google.cloud.discoveryengine.v1alpha.SessionService/ListFiles")
	}
	...
	it.InternalFetch = func(pageSize int, pageToken string) ([]*discoveryenginepb.FileMetadata, string, error) {
		...
		err := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
			var err error
			resp, err = executeRPC(ctx, c.sessionClient.ListFiles, req, settings.GRPC, c.logger, "ListFiles")
			return err
		}, opts...)
		if err != nil {
			return nil, "", err
...
func (c *sessionRESTClient) ListFiles(ctx context.Context, req *discoveryenginepb.ListFilesRequest, opts ...gax.CallOption) *FileMetadataIterator {
	...
	it.InternalFetch = func(pageSize int, pageToken string) ([]*discoveryenginepb.FileMetadata, string, error) {
		...
		baseUrl.Path += fmt.Sprintf("/v1alpha/%v/files", req.GetParent())
