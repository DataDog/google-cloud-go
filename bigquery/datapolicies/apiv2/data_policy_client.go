...
type DataPolicyCallOptions struct {
	...
	AddGrantees        []gax.CallOption
	RemoveGrantees     []gax.CallOption
...
type internalDataPolicyClient interface {
	...
	AddGrantees(context.Context, *datapoliciespb.AddGranteesRequest, ...gax.CallOption) (*datapoliciespb.DataPolicy, error)
	RemoveGrantees(context.Context, *datapoliciespb.RemoveGranteesRequest, ...gax.CallOption) (*datapoliciespb.DataPolicy, error)
...
// CreateDataPolicy creates a new data policy under a project with the given data_policy_id
...
// ignored.
func (c *DataPolicyClient) AddGrantees(ctx context.Context, req *datapoliciespb.AddGranteesRequest, opts ...gax.CallOption) (*datapoliciespb.DataPolicy, error) {
	return c.internalClient.AddGrantees(ctx, req, opts...)
}
...
// ignored.
func (c *DataPolicyClient) RemoveGrantees(ctx context.Context, req *datapoliciespb.RemoveGranteesRequest, opts ...gax.CallOption) (*datapoliciespb.DataPolicy, error) {
	return c.internalClient.RemoveGrantees(ctx, req, opts...)
}
...
func NewDataPolicyClient(ctx context.Context, opts ...option.ClientOption) (*DataPolicyClient, error) {
	...
	if gax.IsFeatureEnabled("TRACING") || gax.IsFeatureEnabled("LOGGING") {
		clientOpts = append(clientOpts, internaloption.WithTelemetryAttributes(map[string]string{
			...
			"gcp.client.artifact": "cloud.google.com/go/bigquery/datapolicies/apiv2",
	...
	if gax.IsFeatureEnabled("METRICS") {
		metrics := gax.NewClientMetrics(
			...
			gax.WithTelemetryAttributes(map[string]string{
				...
				gax.ClientArtifact: "cloud.google.com/go/bigquery/datapolicies/apiv2",
				gax.RPCSystem:      "grpc",
		...
		client.CallOptions.AddGrantees = append(client.CallOptions.AddGrantees, gax.WithClientMetrics(metrics))
		client.CallOptions.RemoveGrantees = append(client.CallOptions.RemoveGrantees, gax.WithClientMetrics(metrics))
...
func NewDataPolicyRESTClient(ctx context.Context, opts ...option.ClientOption) (*DataPolicyClient, error) {
	...
	if gax.IsFeatureEnabled("METRICS") {
		...
		callOpts.AddGrantees = append(callOpts.AddGrantees, gax.WithClientMetrics(metrics))
		callOpts.RemoveGrantees = append(callOpts.RemoveGrantees, gax.WithClientMetrics(metrics))
...
func (c *dataPolicyGRPCClient) CreateDataPolicy(ctx context.Context, req *datapoliciespb.CreateDataPolicyRequest, opts ...gax.CallOption) (*datapoliciespb.DataPolicy, error) {
	...
	if gax.IsFeatureEnabled("METRICS") || gax.IsFeatureEnabled("TRACING") || gax.IsFeatureEnabled("LOGGING") {
		ctx = callctx.WithTelemetryContext(ctx, "rpc_method", "google.cloud.bigquery.datapolicies.v2.DataPolicyService/CreateDataPolicy")
	}
...
func (c *dataPolicyGRPCClient) AddGrantees(ctx context.Context, req *datapoliciespb.AddGranteesRequest, opts ...gax.CallOption) (*datapoliciespb.DataPolicy, error) {
	hds := []string{"x-goog-request-params", fmt.Sprintf("%s=%v", "data_policy", url.QueryEscape(req.GetDataPolicy()))}
	...
	if gax.IsFeatureEnabled("METRICS") || gax.IsFeatureEnabled("TRACING") || gax.IsFeatureEnabled("LOGGING") {
		ctx = callctx.WithTelemetryContext(ctx, "rpc_method", "google.cloud.bigquery.datapolicies.v2.DataPolicyService/AddGrantees")
	}
	opts = append((*c.CallOptions).AddGrantees[0:len((*c.CallOptions).AddGrantees):len((*c.CallOptions).AddGrantees)], opts...)
	var resp *datapoliciespb.DataPolicy
	err := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
		var err error
		resp, err = executeRPC(ctx, c.dataPolicyClient.AddGrantees, req, settings.GRPC, c.logger, "AddGrantees")
		return err
	}, opts...)
	if err != nil {
		return nil, err
...
func (c *dataPolicyGRPCClient) RemoveGrantees(ctx context.Context, req *datapoliciespb.RemoveGranteesRequest, opts ...gax.CallOption) (*datapoliciespb.DataPolicy, error) {
	hds := []string{"x-goog-request-params", fmt.Sprintf("%s=%v", "data_policy", url.QueryEscape(req.GetDataPolicy()))}
	...
	if gax.IsFeatureEnabled("METRICS") || gax.IsFeatureEnabled("TRACING") || gax.IsFeatureEnabled("LOGGING") {
		ctx = callctx.WithTelemetryContext(ctx, "rpc_method", "google.cloud.bigquery.datapolicies.v2.DataPolicyService/RemoveGrantees")
	}
	opts = append((*c.CallOptions).RemoveGrantees[0:len((*c.CallOptions).RemoveGrantees):len((*c.CallOptions).RemoveGrantees)], opts...)
	var resp *datapoliciespb.DataPolicy
	err := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
		var err error
		resp, err = executeRPC(ctx, c.dataPolicyClient.RemoveGrantees, req, settings.GRPC, c.logger, "RemoveGrantees")
		return err
	}, opts...)
	if err != nil {
		return nil, err
...
func (c *dataPolicyGRPCClient) UpdateDataPolicy(ctx context.Context, req *datapoliciespb.UpdateDataPolicyRequest, opts ...gax.CallOption) (*datapoliciespb.DataPolicy, error) {
	...
	if gax.IsFeatureEnabled("METRICS") || gax.IsFeatureEnabled("TRACING") || gax.IsFeatureEnabled("LOGGING") {
		ctx = callctx.WithTelemetryContext(ctx, "rpc_method", "google.cloud.bigquery.datapolicies.v2.DataPolicyService/UpdateDataPolicy")
	}
...
func (c *dataPolicyGRPCClient) DeleteDataPolicy(ctx context.Context, req *datapoliciespb.DeleteDataPolicyRequest, opts ...gax.CallOption) error {
	...
	if gax.IsFeatureEnabled("METRICS") || gax.IsFeatureEnabled("TRACING") || gax.IsFeatureEnabled("LOGGING") {
		ctx = callctx.WithTelemetryContext(ctx, "rpc_method", "google.cloud.bigquery.datapolicies.v2.DataPolicyService/DeleteDataPolicy")
	}
...
func (c *dataPolicyGRPCClient) GetDataPolicy(ctx context.Context, req *datapoliciespb.GetDataPolicyRequest, opts ...gax.CallOption) (*datapoliciespb.DataPolicy, error) {
	...
	if gax.IsFeatureEnabled("METRICS") || gax.IsFeatureEnabled("TRACING") || gax.IsFeatureEnabled("LOGGING") {
		ctx = callctx.WithTelemetryContext(ctx, "rpc_method", "google.cloud.bigquery.datapolicies.v2.DataPolicyService/GetDataPolicy")
	}
...
func (c *dataPolicyGRPCClient) ListDataPolicies(ctx context.Context, req *datapoliciespb.ListDataPoliciesRequest, opts ...gax.CallOption) *DataPolicyIterator {
	...
	if gax.IsFeatureEnabled("METRICS") || gax.IsFeatureEnabled("TRACING") || gax.IsFeatureEnabled("LOGGING") {
		ctx = callctx.WithTelemetryContext(ctx, "rpc_method", "google.cloud.bigquery.datapolicies.v2.DataPolicyService/ListDataPolicies")
	}
...
func (c *dataPolicyGRPCClient) GetIamPolicy(ctx context.Context, req *iampb.GetIamPolicyRequest, opts ...gax.CallOption) (*iampb.Policy, error) {
	...
	if gax.IsFeatureEnabled("METRICS") || gax.IsFeatureEnabled("TRACING") || gax.IsFeatureEnabled("LOGGING") {
		ctx = callctx.WithTelemetryContext(ctx, "rpc_method", "google.cloud.bigquery.datapolicies.v2.DataPolicyService/GetIamPolicy")
	}
...
func (c *dataPolicyGRPCClient) SetIamPolicy(ctx context.Context, req *iampb.SetIamPolicyRequest, opts ...gax.CallOption) (*iampb.Policy, error) {
	...
	if gax.IsFeatureEnabled("METRICS") || gax.IsFeatureEnabled("TRACING") || gax.IsFeatureEnabled("LOGGING") {
		ctx = callctx.WithTelemetryContext(ctx, "rpc_method", "google.cloud.bigquery.datapolicies.v2.DataPolicyService/SetIamPolicy")
	}
...
func (c *dataPolicyGRPCClient) TestIamPermissions(ctx context.Context, req *iampb.TestIamPermissionsRequest, opts ...gax.CallOption) (*iampb.TestIamPermissionsResponse, error) {
	...
	if gax.IsFeatureEnabled("METRICS") || gax.IsFeatureEnabled("TRACING") || gax.IsFeatureEnabled("LOGGING") {
		ctx = callctx.WithTelemetryContext(ctx, "rpc_method", "google.cloud.bigquery.datapolicies.v2.DataPolicyService/TestIamPermissions")
	}
...
func (c *dataPolicyRESTClient) CreateDataPolicy(ctx context.Context, req *datapoliciespb.CreateDataPolicyRequest, opts ...gax.CallOption) (*datapoliciespb.DataPolicy, error) {
	...
	baseUrl.Path += fmt.Sprintf("/v2/%v/dataPolicies", req.GetParent())
	...
	if gax.IsFeatureEnabled("METRICS") || gax.IsFeatureEnabled("TRACING") || gax.IsFeatureEnabled("LOGGING") {
		ctx = callctx.WithTelemetryContext(ctx, "rpc_method", "google.cloud.bigquery.datapolicies.v2.DataPolicyService/CreateDataPolicy")
		ctx = callctx.WithTelemetryContext(ctx, "url_template", "/v2/{parent=projects/*/locations/*}/dataPolicies")
	}
	opts = append((*c.CallOptions).CreateDataPolicy[0:len((*c.CallOptions).CreateDataPolicy):len((*c.CallOptions).CreateDataPolicy)], opts...)
...
// If the request contains a grantee that already exists, the grantee will be
// ignored.
func (c *dataPolicyRESTClient) AddGrantees(ctx context.Context, req *datapoliciespb.AddGranteesRequest, opts ...gax.CallOption) (*datapoliciespb.DataPolicy, error) {
	m := protojson.MarshalOptions{AllowPartial: true, UseEnumNumbers: true}
	jsonReq, err := m.Marshal(req)
	if err != nil {
		return nil, err
	...
	baseUrl.Path += fmt.Sprintf("/v2/%v:addGrantees", req.GetDataPolicy())
	...
	if gax.IsFeatureEnabled("METRICS") || gax.IsFeatureEnabled("TRACING") || gax.IsFeatureEnabled("LOGGING") {
		ctx = callctx.WithTelemetryContext(ctx, "rpc_method", "google.cloud.bigquery.datapolicies.v2.DataPolicyService/AddGrantees")
		ctx = callctx.WithTelemetryContext(ctx, "url_template", "/v2/{data_policy=projects/*/locations/*/dataPolicies/*}:addGrantees")
	}
	opts = append((*c.CallOptions).AddGrantees[0:len((*c.CallOptions).AddGrantees):len((*c.CallOptions).AddGrantees)], opts...)
	unm := protojson.UnmarshalOptions{AllowPartial: true, DiscardUnknown: true}
	resp := &datapoliciespb.DataPolicy{}
	e := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
		...
		buf, err := executeHTTPRequest(ctx, c.httpClient, httpReq, c.logger, jsonReq, "AddGrantees")
		if err != nil {
			return err
		}
...
// If the request contains a grantee that does not exist, the grantee will be
// ignored.
func (c *dataPolicyRESTClient) RemoveGrantees(ctx context.Context, req *datapoliciespb.RemoveGranteesRequest, opts ...gax.CallOption) (*datapoliciespb.DataPolicy, error) {
	m := protojson.MarshalOptions{AllowPartial: true, UseEnumNumbers: true}
	jsonReq, err := m.Marshal(req)
	if err != nil {
		return nil, err
	...
	baseUrl.Path += fmt.Sprintf("/v2/%v:removeGrantees", req.GetDataPolicy())
	...
	if gax.IsFeatureEnabled("METRICS") || gax.IsFeatureEnabled("TRACING") || gax.IsFeatureEnabled("LOGGING") {
		ctx = callctx.WithTelemetryContext(ctx, "rpc_method", "google.cloud.bigquery.datapolicies.v2.DataPolicyService/RemoveGrantees")
		ctx = callctx.WithTelemetryContext(ctx, "url_template", "/v2/{data_policy=projects/*/locations/*/dataPolicies/*}:removeGrantees")
	}
	opts = append((*c.CallOptions).RemoveGrantees[0:len((*c.CallOptions).RemoveGrantees):len((*c.CallOptions).RemoveGrantees)], opts...)
	unm := protojson.UnmarshalOptions{AllowPartial: true, DiscardUnknown: true}
	resp := &datapoliciespb.DataPolicy{}
	e := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
		...
		buf, err := executeHTTPRequest(ctx, c.httpClient, httpReq, c.logger, jsonReq, "RemoveGrantees")
		if err != nil {
			return err
		}
...
func (c *dataPolicyRESTClient) UpdateDataPolicy(ctx context.Context, req *datapoliciespb.UpdateDataPolicyRequest, opts ...gax.CallOption) (*datapoliciespb.DataPolicy, error) {
	...
	baseUrl.Path += fmt.Sprintf("/v2/%v", req.GetDataPolicy().GetName())
	...
	if gax.IsFeatureEnabled("METRICS") || gax.IsFeatureEnabled("TRACING") || gax.IsFeatureEnabled("LOGGING") {
		ctx = callctx.WithTelemetryContext(ctx, "rpc_method", "google.cloud.bigquery.datapolicies.v2.DataPolicyService/UpdateDataPolicy")
		ctx = callctx.WithTelemetryContext(ctx, "url_template", "/v2/{data_policy.name=projects/*/locations/*/dataPolicies/*}")
	}
	opts = append((*c.CallOptions).UpdateDataPolicy[0:len((*c.CallOptions).UpdateDataPolicy):len((*c.CallOptions).UpdateDataPolicy)], opts...)
	unm := protojson.UnmarshalOptions{AllowPartial: true, DiscardUnknown: true}
	resp := &datapoliciespb.DataPolicy{}
...
func (c *dataPolicyRESTClient) DeleteDataPolicy(ctx context.Context, req *datapoliciespb.DeleteDataPolicyRequest, opts ...gax.CallOption) error {
	...
	if gax.IsFeatureEnabled("METRICS") || gax.IsFeatureEnabled("TRACING") || gax.IsFeatureEnabled("LOGGING") {
		ctx = callctx.WithTelemetryContext(ctx, "rpc_method", "google.cloud.bigquery.datapolicies.v2.DataPolicyService/DeleteDataPolicy")
		ctx = callctx.WithTelemetryContext(ctx, "url_template", "/v2/{name=projects/*/locations/*/dataPolicies/*}")
	}
...
func (c *dataPolicyRESTClient) GetIamPolicy(ctx context.Context, req *iampb.GetIamPolicyRequest, opts ...gax.CallOption) (*iampb.Policy, error) {
	...
	if gax.IsFeatureEnabled("METRICS") || gax.IsFeatureEnabled("TRACING") || gax.IsFeatureEnabled("LOGGING") {
		ctx = callctx.WithTelemetryContext(ctx, "rpc_method", "google.cloud.bigquery.datapolicies.v2.DataPolicyService/GetIamPolicy")
		ctx = callctx.WithTelemetryContext(ctx, "url_template", "/v2/{resource=projects/*/locations/*/dataPolicies/*}:getIamPolicy")
	}
	opts = append((*c.CallOptions).GetIamPolicy[0:len((*c.CallOptions).GetIamPolicy):len((*c.CallOptions).GetIamPolicy)], opts...)
	unm := protojson.UnmarshalOptions{AllowPartial: true, DiscardUnknown: true}
	resp := &iampb.Policy{}
...
func (c *dataPolicyRESTClient) SetIamPolicy(ctx context.Context, req *iampb.SetIamPolicyRequest, opts ...gax.CallOption) (*iampb.Policy, error) {
	...
	if gax.IsFeatureEnabled("METRICS") || gax.IsFeatureEnabled("TRACING") || gax.IsFeatureEnabled("LOGGING") {
		ctx = callctx.WithTelemetryContext(ctx, "rpc_method", "google.cloud.bigquery.datapolicies.v2.DataPolicyService/SetIamPolicy")
		ctx = callctx.WithTelemetryContext(ctx, "url_template", "/v2/{resource=projects/*/locations/*/dataPolicies/*}:setIamPolicy")
	}
	opts = append((*c.CallOptions).SetIamPolicy[0:len((*c.CallOptions).SetIamPolicy):len((*c.CallOptions).SetIamPolicy)], opts...)
	unm := protojson.UnmarshalOptions{AllowPartial: true, DiscardUnknown: true}
	resp := &iampb.Policy{}
...
func (c *dataPolicyRESTClient) TestIamPermissions(ctx context.Context, req *iampb.TestIamPermissionsRequest, opts ...gax.CallOption) (*iampb.TestIamPermissionsResponse, error) {
	...
	if gax.IsFeatureEnabled("METRICS") || gax.IsFeatureEnabled("TRACING") || gax.IsFeatureEnabled("LOGGING") {
		ctx = callctx.WithTelemetryContext(ctx, "rpc_method", "google.cloud.bigquery.datapolicies.v2.DataPolicyService/TestIamPermissions")
		ctx = callctx.WithTelemetryContext(ctx, "url_template", "/v2/{resource=projects/*/locations/*/dataPolicies/*}:testIamPermissions")
	}
	opts = append((*c.CallOptions).TestIamPermissions[0:len((*c.CallOptions).TestIamPermissions):len((*c.CallOptions).TestIamPermissions)], opts...)
	unm := protojson.UnmarshalOptions{AllowPartial: true, DiscardUnknown: true}
