...
func (c *regionSnapshotSettingsRESTClient) Get(ctx context.Context, req *computepb.GetRegionSnapshotSettingRequest, opts ...gax.CallOption) (*computepb.SnapshotSettings, error) {
	...
	baseUrl.Path += fmt.Sprintf("/compute/v1/projects/%v/regions/%v/snapshotSettings", req.GetProject(), req.GetRegion())
	...
	if gax.IsFeatureEnabled("METRICS") || gax.IsFeatureEnabled("TRACING") || gax.IsFeatureEnabled("LOGGING") {
		ctx = callctx.WithTelemetryContext(ctx, "rpc_method", "google.cloud.compute.v1.RegionSnapshotSettings/Get")
		ctx = callctx.WithTelemetryContext(ctx, "url_template", "/compute/v1/projects/{project}/regions/{region}/snapshotSettings")
	}
...
func (c *regionSnapshotSettingsRESTClient) Patch(ctx context.Context, req *computepb.PatchRegionSnapshotSettingRequest, opts ...gax.CallOption) (*Operation, error) {
	...
	if gax.IsFeatureEnabled("METRICS") || gax.IsFeatureEnabled("TRACING") || gax.IsFeatureEnabled("LOGGING") {
		ctx = callctx.WithTelemetryContext(ctx, "rpc_method", "google.cloud.compute.v1.RegionSnapshotSettings/Patch")
		ctx = callctx.WithTelemetryContext(ctx, "url_template", "/compute/v1/projects/{project}/regions/{region}/snapshotSettings")
	}
