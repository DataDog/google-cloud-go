...
var newRegionSnapshotsClientHook clientHook
...
func defaultRegionSnapshotsRESTCallOptions() *RegionSnapshotsCallOptions {
	return &RegionSnapshotsCallOptions{
		Delete: []gax.CallOption{
...
type internalRegionSnapshotsClient interface {
	...
	Delete(context.Context, *computepb.DeleteRegionSnapshotRequest, ...gax.CallOption) (*Operation, error)
	Get(context.Context, *computepb.GetRegionSnapshotRequest, ...gax.CallOption) (*computepb.Snapshot, error)
	GetIamPolicy(context.Context, *computepb.GetIamPolicyRegionSnapshotRequest, ...gax.CallOption) (*computepb.Policy, error)
	Insert(context.Context, *computepb.InsertRegionSnapshotRequest, ...gax.CallOption) (*Operation, error)
	List(context.Context, *computepb.ListRegionSnapshotsRequest, ...gax.CallOption) *SnapshotIterator
...
func (c *RegionSnapshotsClient) setGoogleClientInfo(keyval ...string) {
...
type regionSnapshotsRESTClient struct {
	...
	// Points back to the CallOptions field of the containing RegionSnapshotsClient
	CallOptions **RegionSnapshotsCallOptions
...
func NewRegionSnapshotsRESTClient(ctx context.Context, opts ...option.ClientOption) (*RegionSnapshotsClient, error) {
	clientOpts := append(defaultRegionSnapshotsRESTClientOptions(), opts...)
	...
	callOpts := defaultRegionSnapshotsRESTCallOptions()
	c := &regionSnapshotsRESTClient{
		endpoint:    endpoint,
	...
	return &RegionSnapshotsClient{internalClient: c, CallOptions: callOpts}, nil
}

func defaultRegionSnapshotsRESTClientOptions() []option.ClientOption {
...
// the `x-goog-api-client` header passed on each request. Intended for
// use by Google-written clients.
func (c *regionSnapshotsRESTClient) setGoogleClientInfo(keyval ...string) {
...
func (c *regionSnapshotsRESTClient) Connection() *grpc.ClientConn {
	return nil
}
...
func (c *regionSnapshotsRESTClient) Delete(ctx context.Context, req *computepb.DeleteRegionSnapshotRequest, opts ...gax.CallOption) (*Operation, error) {
	...
	baseUrl.Path += fmt.Sprintf("/compute/v1/projects/%v/regions/%v/snapshots/%v", req.GetProject(), req.GetRegion(), req.GetSnapshot())
...
// Get returns the specified Snapshot resource.
func (c *regionSnapshotsRESTClient) Get(ctx context.Context, req *computepb.GetRegionSnapshotRequest, opts ...gax.CallOption) (*computepb.Snapshot, error) {
	baseUrl, err := url.Parse(c.endpoint)
	if err != nil {
		return nil, err
	}
...
func (c *regionSnapshotsRESTClient) GetIamPolicy(ctx context.Context, req *computepb.GetIamPolicyRegionSnapshotRequest, opts ...gax.CallOption) (*computepb.Policy, error) {
	...
	baseUrl.Path += fmt.Sprintf("/compute/v1/projects/%v/regions/%v/snapshots/%v/getIamPolicy", req.GetProject(), req.GetRegion(), req.GetResource())
...
func (c *regionSnapshotsRESTClient) Insert(ctx context.Context, req *computepb.InsertRegionSnapshotRequest, opts ...gax.CallOption) (*Operation, error) {
	...
	baseUrl.Path += fmt.Sprintf("/compute/v1/projects/%v/regions/%v/snapshots", req.GetProject(), req.GetRegion())
...
func (c *regionSnapshotsRESTClient) SetIamPolicy(ctx context.Context, req *computepb.SetIamPolicyRegionSnapshotRequest, opts ...gax.CallOption) (*computepb.Policy, error) {
	...
	baseUrl.Path += fmt.Sprintf("/compute/v1/projects/%v/regions/%v/snapshots/%v/setIamPolicy", req.GetProject(), req.GetRegion(), req.GetResource())
...
func (c *regionSnapshotsRESTClient) SetLabels(ctx context.Context, req *computepb.SetLabelsRegionSnapshotRequest, opts ...gax.CallOption) (*Operation, error) {
	...
	baseUrl.Path += fmt.Sprintf("/compute/v1/projects/%v/regions/%v/snapshots/%v/setLabels", req.GetProject(), req.GetRegion(), req.GetResource())
...
// TestIamPermissions returns permissions that a caller has on the specified resource.
func (c *regionSnapshotsRESTClient) TestIamPermissions(ctx context.Context, req *computepb.TestIamPermissionsRegionSnapshotRequest, opts ...gax.CallOption) (*computepb.TestPermissionsResponse, error) {
	m := protojson.MarshalOptions{AllowPartial: true}
	...
	baseUrl.Path += fmt.Sprintf("/compute/v1/projects/%v/regions/%v/snapshots/%v/testIamPermissions", req.GetProject(), req.GetRegion(), req.GetResource())
...
func (c *regionSnapshotsRESTClient) UpdateKmsKey(ctx context.Context, req *computepb.UpdateKmsKeyRegionSnapshotRequest, opts ...gax.CallOption) (*Operation, error) {
	...
	baseUrl.Path += fmt.Sprintf("/compute/v1/projects/%v/regions/%v/snapshots/%v/updateKmsKey", req.GetProject(), req.GetRegion(), req.GetSnapshot())
