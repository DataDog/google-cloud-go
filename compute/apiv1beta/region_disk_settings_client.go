...
var newRegionDiskSettingsClientHook clientHook
...
func defaultRegionDiskSettingsRESTCallOptions() *RegionDiskSettingsCallOptions {
	return &RegionDiskSettingsCallOptions{
		Get: []gax.CallOption{
...
// internalRegionDiskSettingsClient is an interface that defines the methods available from Google Compute Engine API.
type internalRegionDiskSettingsClient interface {
	Close() error
	setGoogleClientInfo(...string)
	Connection() *grpc.ClientConn
	Get(context.Context, *computepb.GetRegionDiskSettingRequest, ...gax.CallOption) (*computepb.DiskSettings, error)
	Patch(context.Context, *computepb.PatchRegionDiskSettingRequest, ...gax.CallOption) (*Operation, error)
}

// RegionDiskSettingsClient is a client for interacting with Google Compute Engine API.
// Methods, except Close, may be called concurrently. However, fields must not be modified concurrently with method calls.
//
// The RegionDiskSettings API.
type RegionDiskSettingsClient struct {
	// The internal transport-dependent client.
	internalClient internalRegionDiskSettingsClient
...
func (c *RegionDiskSettingsClient) setGoogleClientInfo(keyval ...string) {
...
// Methods, except Close, may be called concurrently. However, fields must not be modified concurrently with method calls.
type regionDiskSettingsRESTClient struct {
	...
	// Points back to the CallOptions field of the containing RegionDiskSettingsClient
	CallOptions **RegionDiskSettingsCallOptions
...
func NewRegionDiskSettingsRESTClient(ctx context.Context, opts ...option.ClientOption) (*RegionDiskSettingsClient, error) {
	clientOpts := append(defaultRegionDiskSettingsRESTClientOptions(), opts...)
	...
	callOpts := defaultRegionDiskSettingsRESTCallOptions()
	c := &regionDiskSettingsRESTClient{
		endpoint:    endpoint,
	...
	return &RegionDiskSettingsClient{internalClient: c, CallOptions: callOpts}, nil
}

func defaultRegionDiskSettingsRESTClientOptions() []option.ClientOption {
...
// the `x-goog-api-client` header passed on each request. Intended for
// use by Google-written clients.
func (c *regionDiskSettingsRESTClient) setGoogleClientInfo(keyval ...string) {
...
// Close closes the connection to the API service. **Always** call Close() when
// the client is no longer required.
func (c *regionDiskSettingsRESTClient) Close() error {
...
func (c *regionDiskSettingsRESTClient) Connection() *grpc.ClientConn {
	return nil
}

// Get get Regional Disk Settings.
func (c *regionDiskSettingsRESTClient) Get(ctx context.Context, req *computepb.GetRegionDiskSettingRequest, opts ...gax.CallOption) (*computepb.DiskSettings, error) {
	baseUrl, err := url.Parse(c.endpoint)
	if err != nil {
		return nil, err
	}
	baseUrl.Path += fmt.Sprintf("/compute/beta/projects/%v/regions/%v/diskSettings", req.GetProject(), req.GetRegion())
	...
	if gax.IsFeatureEnabled("METRICS") || gax.IsFeatureEnabled("TRACING") || gax.IsFeatureEnabled("LOGGING") {
		ctx = callctx.WithTelemetryContext(ctx, "rpc_method", "google.cloud.compute.v1beta.RegionDiskSettings/Get")
		ctx = callctx.WithTelemetryContext(ctx, "url_template", "/compute/beta/projects/{project}/regions/{region}/diskSettings")
	}
...
// Patch patch Regional Disk Settings
func (c *regionDiskSettingsRESTClient) Patch(ctx context.Context, req *computepb.PatchRegionDiskSettingRequest, opts ...gax.CallOption) (*Operation, error) {
	m := protojson.MarshalOptions{AllowPartial: true}
	body := req.GetDiskSettingsResource()
	...
	if gax.IsFeatureEnabled("METRICS") || gax.IsFeatureEnabled("TRACING") || gax.IsFeatureEnabled("LOGGING") {
		ctx = callctx.WithTelemetryContext(ctx, "rpc_method", "google.cloud.compute.v1beta.RegionDiskSettings/Patch")
		ctx = callctx.WithTelemetryContext(ctx, "url_template", "/compute/beta/projects/{project}/regions/{region}/diskSettings")
	}
