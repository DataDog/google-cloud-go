...
type internalTargetHttpProxiesClient interface {
	...
	TestIamPermissions(context.Context, *computepb.TestIamPermissionsTargetHttpProxyRequest, ...gax.CallOption) (*computepb.TestPermissionsResponse, error)
}
...
func (c *targetHttpProxiesRESTClient) AggregatedList(ctx context.Context, req *computepb.AggregatedListTargetHttpProxiesRequest, opts ...gax.CallOption) *TargetHttpProxiesScopedListPairIterator {
	...
	it.InternalFetch = func(pageSize int, pageToken string) ([]TargetHttpProxiesScopedListPair, string, error) {
		...
		baseUrl.Path += fmt.Sprintf("/compute/beta/projects/%v/aggregated/targetHttpProxies", req.GetProject())
...
func (c *targetHttpProxiesRESTClient) Delete(ctx context.Context, req *computepb.DeleteTargetHttpProxyRequest, opts ...gax.CallOption) (*Operation, error) {
	...
	baseUrl.Path += fmt.Sprintf("/compute/beta/projects/%v/global/targetHttpProxies/%v", req.GetProject(), req.GetTargetHttpProxy())
...
func (c *targetHttpProxiesRESTClient) Insert(ctx context.Context, req *computepb.InsertTargetHttpProxyRequest, opts ...gax.CallOption) (*Operation, error) {
	...
	baseUrl.Path += fmt.Sprintf("/compute/beta/projects/%v/global/targetHttpProxies", req.GetProject())
...
func (c *targetHttpProxiesRESTClient) SetUrlMap(ctx context.Context, req *computepb.SetUrlMapTargetHttpProxyRequest, opts ...gax.CallOption) (*Operation, error) {
	...
	baseUrl.Path += fmt.Sprintf("/compute/beta/projects/%v/targetHttpProxies/%v/setUrlMap", req.GetProject(), req.GetTargetHttpProxy())
...
// TestIamPermissions returns permissions that a caller has on the specified resource.
func (c *targetHttpProxiesRESTClient) TestIamPermissions(ctx context.Context, req *computepb.TestIamPermissionsTargetHttpProxyRequest, opts ...gax.CallOption) (*computepb.TestPermissionsResponse, error) {
	m := protojson.MarshalOptions{AllowPartial: true}
	...
	baseUrl.Path += fmt.Sprintf("/compute/beta/projects/%v/global/targetHttpProxies/%v/testIamPermissions", req.GetProject(), req.GetResource())
