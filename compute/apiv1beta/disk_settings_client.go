...
var newDiskSettingsClientHook clientHook
...
func defaultDiskSettingsRESTCallOptions() *DiskSettingsCallOptions {
	return &DiskSettingsCallOptions{
		Get: []gax.CallOption{
...
type internalDiskSettingsClient interface {
	...
	Get(context.Context, *computepb.GetDiskSettingRequest, ...gax.CallOption) (*computepb.DiskSettings, error)
...
type DiskSettingsClient struct {
	...
	internalClient internalDiskSettingsClient
...
func (c *DiskSettingsClient) setGoogleClientInfo(keyval ...string) {
...
// Methods, except Close, may be called concurrently. However, fields must not be modified concurrently with method calls.
type diskSettingsRESTClient struct {
	...
	// Points back to the CallOptions field of the containing DiskSettingsClient
	CallOptions **DiskSettingsCallOptions
...
func NewDiskSettingsRESTClient(ctx context.Context, opts ...option.ClientOption) (*DiskSettingsClient, error) {
	...
	callOpts := defaultDiskSettingsRESTCallOptions()
	c := &diskSettingsRESTClient{
		endpoint:    endpoint,
	...
	return &DiskSettingsClient{internalClient: c, CallOptions: callOpts}, nil
}

func defaultDiskSettingsRESTClientOptions() []option.ClientOption {
...
// the `x-goog-api-client` header passed on each request. Intended for
// use by Google-written clients.
func (c *diskSettingsRESTClient) setGoogleClientInfo(keyval ...string) {
...
func (c *diskSettingsRESTClient) Connection() *grpc.ClientConn {
	return nil
}

// Get get Zonal Disk Settings.
func (c *diskSettingsRESTClient) Get(ctx context.Context, req *computepb.GetDiskSettingRequest, opts ...gax.CallOption) (*computepb.DiskSettings, error) {
	baseUrl, err := url.Parse(c.endpoint)
	if err != nil {
		return nil, err
	}
	baseUrl.Path += fmt.Sprintf("/compute/beta/projects/%v/zones/%v/diskSettings", req.GetProject(), req.GetZone())
...
// Patch patch Zonal Disk Settings
func (c *diskSettingsRESTClient) Patch(ctx context.Context, req *computepb.PatchDiskSettingRequest, opts ...gax.CallOption) (*Operation, error) {
